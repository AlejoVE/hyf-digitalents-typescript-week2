...
var fetchQuestions = function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, axios('https://the-trivia-api.com/api/questions?limit=5')
            ...
            case 1:
                ...
                filteredData.forEach(function ($question) {
                ...
                sortedArray = arr.sort(function (a, b) { return a.difficultyValue - b.difficultyValue; });
                sortedArray.forEach(function (_a) {
                    var question = _a.question, difficulty = _a.difficulty;
                    console.log("\n".concat(colors.cyan("".concat(question)).bold, " || ").concat(colors.magenta("Difficulty: ".concat(difficulty)).italic, "\n"));
                });
                return [2 /*return*/];
        }
    });
